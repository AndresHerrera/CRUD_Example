...
$sentencia = $base_de_datos->prepare("INSERT INTO edificios_crud(nombre, codigo) VALUES (?, ?);");
$resultado = $sentencia->execute([$nombre, $codigo]); # Pasar en el mismo orden de los ?
